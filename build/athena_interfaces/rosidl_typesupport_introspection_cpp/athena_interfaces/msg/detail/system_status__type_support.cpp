...
{
  new (message_memory) athena_interfaces::msg::SystemStatus(_init);
}

void SystemStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<athena_interfaces::msg::SystemStatus *>(message_memory);
  typed_message->~SystemStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SystemStatus_message_member_array[5] = {
  {
    "overall_state",  // name
    ...
    offsetof(athena_interfaces::msg::SystemStatus, overall_state),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(athena_interfaces::msg::SystemStatus, active_nodes),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(athena_interfaces::msg::SystemStatus, warning_count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(athena_interfaces::msg::SystemStatus, error_count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(athena_interfaces::msg::SystemStatus, timestamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SystemStatus_message_members = {
  ...
  5,  // number of fields
  sizeof(athena_interfaces::msg::SystemStatus),
...
{
  return &::athena_interfaces::msg::rosidl_typesupport_introspection_cpp::SystemStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, athena_interfaces, msg, SystemStatus)() {
  return &::athena_interfaces::msg::rosidl_typesupport_introspection_cpp::SystemStatus_message_type_support_handle;
}
