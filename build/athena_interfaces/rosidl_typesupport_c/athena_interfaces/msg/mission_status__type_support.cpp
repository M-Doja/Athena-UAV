...
static const _MissionStatus_type_support_symbol_names_t _MissionStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, athena_interfaces, msg, MissionStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, athena_interfaces, msg, MissionStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, athena_interfaces, msg, MissionStatus)() {
  return &::athena_interfaces::msg::rosidl_typesupport_c::MissionStatus_message_type_support_handle;
}
