...
static const _SystemStatus_type_support_symbol_names_t _SystemStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, athena_interfaces, msg, SystemStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, athena_interfaces, msg, SystemStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, athena_interfaces, msg, SystemStatus)() {
  return &::athena_interfaces::msg::rosidl_typesupport_c::SystemStatus_message_type_support_handle;
}
