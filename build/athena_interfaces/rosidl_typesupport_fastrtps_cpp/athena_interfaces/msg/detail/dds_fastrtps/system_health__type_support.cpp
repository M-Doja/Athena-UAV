...
#include "athena_interfaces/msg/detail/system_health__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = athena_interfaces::msg::SystemHealth;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const athena_interfaces::msg::SystemHealth *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<athena_interfaces::msg::SystemHealth *>(
    untyped_ros_message);
...
{
  return &athena_interfaces::msg::typesupport_fastrtps_cpp::_SystemHealth__handle;
}
