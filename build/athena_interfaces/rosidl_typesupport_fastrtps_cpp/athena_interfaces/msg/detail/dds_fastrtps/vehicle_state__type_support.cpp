...
#include "athena_interfaces/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = athena_interfaces::msg::VehicleState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const athena_interfaces::msg::VehicleState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<athena_interfaces::msg::VehicleState *>(
    untyped_ros_message);
...
{
  return &athena_interfaces::msg::typesupport_fastrtps_cpp::_VehicleState__handle;
}
