...
class Metaclass_SystemStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('athena_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'athena_interfaces.msg.SystemStatus')
            logger.debug(
...
class SystemStatus(metaclass=Metaclass_SystemStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.overall_state = kwargs.get('overall_state', str())
        self.active_nodes = kwargs.get('active_nodes', int())
        self.warning_count = kwargs.get('warning_count', int())
    ...
    def __eq__(self, other):
        ...
        if self.overall_state != other.overall_state:
            return False
        if self.active_nodes != other.active_nodes:
            return False
        if self.warning_count != other.warning_count:
            return False
    ...
    def overall_state(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'overall_state' field must be of type 'str'"
        self._overall_state = value

    @builtins.property
    def active_nodes(self):
        """Message field 'active_nodes'."""
    ...
    def active_nodes(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'active_nodes' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'active_nodes' field must be an unsigned integer in [0, 4294967295]"
        self._active_nodes = value

    @builtins.property
    def warning_count(self):
        """Message field 'warning_count'."""
    ...
    def warning_count(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'warning_count' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'warning_count' field must be an unsigned integer in [0, 4294967295]"
