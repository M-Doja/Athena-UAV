...
bool athena_interfaces__msg__system_health__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("athena_interfaces.msg._system_health.SystemHealth", full_classname_dest, 49) == 0);
  }
  athena_interfaces__msg__SystemHealth * ros_message = _ros_message;
  {  // node_name
...
PyObject * athena_interfaces__msg__system_health__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("athena_interfaces.msg._system_health");
