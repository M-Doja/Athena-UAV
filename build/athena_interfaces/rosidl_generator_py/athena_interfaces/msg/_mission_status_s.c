...
bool athena_interfaces__msg__mission_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("athena_interfaces.msg._mission_status.MissionStatus", full_classname_dest, 51) == 0);
  }
  athena_interfaces__msg__MissionStatus * ros_message = _ros_message;
  {  // mission_id
...
PyObject * athena_interfaces__msg__mission_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("athena_interfaces.msg._mission_status");
